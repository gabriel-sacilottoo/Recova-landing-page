      ...
      {MENU_LINKS.map((link) => (
        ...
        >
          <span className="relative size-5 shrink-0">
            <MeaningfulIcon name={link.label} size={20} className="size-5 transition-opacity duration-200 group-hover:opacity-70" />
          </span>
          {link.label}
        </Link>
      ))}
        ...
        <div className="flex h-[70px] w-full max-w-[450px] items-center justify-between rounded-pill bg-surface-dark py-3 pr-3 pl-4 tablet:max-w-[800px] desktop:max-w-[810px]">
          <Link href="/" aria-label={`${siteConfig.name} — home`} className="shrink-0">
            <Image
              ...
              height={40}
              priority
              className="h-10 w-[108px] brightness-0 invert"
            />
          </Link>
            ...
            <div className="flex items-center">
              ...
              <div ref={dropdownRef} className="relative flex items-center">
                ...
                >
                  ...
                  >
                    <MeaningfulIcon name="chevron" size={20} className="size-5" />
                  </motion.span>
                </button>
                <AnimatePresence>
          ...
          <div ref={mobileRef} className="relative desktop:hidden">
            ...
            >
              <MeaningfulIcon name="menu" size={24} className="size-6 text-ink-800" />
            </button>
            <AnimatePresence>
              {mobileOpen && (
                <div id="mobile-menu">
