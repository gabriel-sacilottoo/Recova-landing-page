...
export function FinalCta() {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "linear-gradient(210.198deg, rgb(6, 92, 245) 0%, rgb(76, 143, 249) 69.6669%)",
      }}
    >
      ...
      <motion.div
        ...
        className="relative flex w-full max-w-[1040px] flex-col items-center gap-[30px]"
      >
        ...
        <ul className="flex flex-wrap items-start justify-center gap-[10px]">
          {finalCta.points.map((point) => (
            ...
            >
              <MeaningfulIcon name="check" size={24} className="size-6 text-accent" />
